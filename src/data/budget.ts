...
export const budgetLines: BudgetLine[] = [
  // --- ubytování ---------------------------------------------------------
  {
    ...
    note: 'Dva dvoulůžkové pokoje. Konkrétní hotel zatím nevybraný.',
  ...
  },
  {
    ...
    note: 'Dřívější orientace 300 000 VND je historická stopa z plánování, ne ověřená cena.',
    min: null, max: null, currency: 'VND', basis: 'per-person',
    confidence: 'unverified',
    dayDates: ['2026-09-30'],
  },
  {
    ...
    note: 'Oběd bývá v ceně plavby — nezapočítávej ho znovu do jídla.',
    min: null, max: null, currency: 'USD', basis: 'per-person',
    confidence: 'unverified',
    dayDates: ['2026-10-03'],
  },
