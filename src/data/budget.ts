...
export const budgetLines: BudgetLine[] = [
  ...
  },
  {
    ...
    note: 'Soukromé auto kolem 30 USD za vůz; sdílený shuttle 30–60 tis. VND na osobu. Uvedeno je auto pro čtyři.',
    min: 30, max: 30, currency: 'USD', basis: 'total',
    confidence: 'published',
  ...
  },
  {
    ...
    note: 'Spodní hranice = vykoupené čtyřlůžkové kupé (870 tis. VND za lůžko, cca 44 USD). Horní = dvě dvoulůžková VIP kupé (207–235 USD za kupé, tedy cca 104–118 USD na osobu). Rozhodnutí ještě nepadlo.',
    min: 44, max: 118, currency: 'USD', basis: 'per-person',
    confidence: 'published',
