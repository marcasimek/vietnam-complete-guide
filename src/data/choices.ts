...
export const choiceGroups: ChoiceGroup[] = [
  ...
  },
  {
    ...
    decisionNotes: [
      'Hotpot = společná večeře, dlouhé sezení, jeden kotlík pro čtyři. Hotpot Center i Quang Minh jsou na stejné ulici Xuân Viên u jezera.',
  ...
  },
  {
    ...
    mode: 'or',
    regionId: 'ninh-binh',
    serviceIds: ['svc-tam-gia-trang', 'svc-hoang-giang-ninhbinh', 'svc-tam-coc-local-eateries'],
    decisionNotes: [
      ...
      'Hoàng Giang leží u Tràng An — sedí na oběd 30. 9. hned po ranní plavbě, aniž bychom se museli vracet do Tam Cốc.',
    ],
  },
  {
  ...
  },
  {
    ...
    mode: 'or',
    regionId: 'cat-ba',
    serviceIds: ['svc-vien-duong-catba', 'svc-yummy-catba', 'svc-catba-local-eateries'],
    decisionNotes: [
      ...
      'Tři dny samý seafood na nábřeží by byly drahé. Střídej to s obyčejnými jídelnami — Viễn Dương i Yummy jsou na Núi Ngọc, jeden blok od vody.',
  ...
  },
  {
    ...
    intro:
      'Čtyři dny, čtyři lidi, dva soukromé pokoje. Nejdůležitější rozhodnutí celé cesty. Strawberry poslalo konkrétní nabídku a odsouhlasilo podmínky; od zbylých dvou nemáme nic.',
    mode: 'pick-one',
    regionId: 'ha-giang',
    ...
    decisionNotes: [
      ...
      'NABÍDKA STRAWBERRY (14. 9. 2026): 6 300 000 VND na osobu za 4D/3N private easy rider, tedy 25 200 000 VND za čtyři. Sedí uprostřed orientační hladiny 212–297 USD na osobu, takže není ani podezřele levná, ani nafouknutá.',
      'Strawberry navíc písemně odsouhlasilo dva soukromé pokoje před loopem i na loopu, denní bus z Hanoje 9:00 → 16:00 za 350 000 VND/os. a noc po loopu za 300 000 VND/pokoj.',
      'Kdo bude výrazně levnější než tahle hladina, bude něco šetřit — zeptej se na čem.',
      'Pojištění řeš sám, ne přes operátora. Spolujízdu na motorce většina cestovních pojistek vylučuje.',
    ],
    openQuestions: [
      'Od QT ani YESD nemáme cenu — nabídka Strawberry tak zatím nemá s čím být porovnaná.',
      'U Strawberry chybí výše zálohy, způsob platby a storno při počasí. Bez toho se neplatí.',
      'Není potvrzené, jestli je noc z 21. na 22. 9. v ceně balíčku, nebo se platí zvlášť jako ta po loopu.',
