...
export const routeNodes: RouteNode[] = [
  // --- hlavní trasa ---------------------------------------------------------
  {
    ...
    note: '19.–21. 9., průjezd 29. 9. a poslední noc 5./6. 10.',
    dayDates: ['2026-09-19', '2026-09-20', '2026-09-29', '2026-10-05', '2026-10-06'],
    labelPos: 'right',
  },
  {
  ...
  },
  {
    ...
    note: 'Coaster, trek v údolí Mường Hoa.',
    dayDates: ['2026-09-26', '2026-09-27'], labelPos: 'bottom',
  },
  {
    id: 'rn-laocai', label: 'Lào Cai', regionId: 'train', group: 'main',
    lat: 22.4966, lng: 103.9718, order: 4, nights: 0,
    note: 'Jen nádraží — odsud jede noční vlak.',
    dayDates: ['2026-09-28'], labelPos: 'top',
  },
  {
    id: 'rn-tamcoc', label: 'Tam Cốc', regionId: 'ninh-binh', group: 'main',
    lat: 20.2192, lng: 105.9375, order: 5, nights: 3,
  ...
  },
  {
    ...
    lat: 20.7250, lng: 107.0470, order: 6, nights: 3,
