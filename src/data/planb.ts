...
export const planB: PlanBScenario[] = [
  ...
  {
    id: 'planb-no-direct-bus',
    title: 'Přímý noční bus nepojede nebo nebude volno',
    trigger: 'Spoj 28./29. 9. je zrušený, nebo nezbudou kabiny ani lehátka.',
    steps: [
      'Varianta A: běžná lehátka místo kabin u stejného dopravce. Horší spaní, stejná trasa i čas.',
      'Varianta B: zpátky na původní řešení — transfer do Lào Cai, noční vlak SP4 do Hanoje a ráno návazný přejezd do Tam Cốc. Obě části jsou v aplikaci pořád popsané.',
      'Varianta C: denní spoj 29. 9. ráno. Stojí noc navíc v Sa Pě a celý odpočinkový blok v Tam Cốc.',
      'Varianta D: noc navíc v Sa Pě a posun celého bloku Ninh Bình o den. Sáhne to i na Cát Bà — až jako poslední.',
    ],
    affectsBookings: ['bk-sapa-tamcoc-bus', 'bk-tamcoc-stay'],
    losses: ['u varianty B se den 29. 9. zkrátí o dopoledne', 'u varianty C a D jeden den v Ninh Bình'],
  },
  {
