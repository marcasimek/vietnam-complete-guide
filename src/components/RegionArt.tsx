...
const ART: Record<RegionId, ReactElement> = {
  ...
  // Sa Pa — vrchol v mlze a rýžové terasy
  sapa: (
    <g>
      <path d="M0 120V56l62-40 58 44 40-26 70 48 54-34 116 44v28z" {...L1} />
      <path d="M120 120V76l44-26 58 40 44-24 134 42v12z" {...L2} />
      <g>
        <path d="M0 78c46-10 80 6 124 2s70-16 116-10 106 16 160 8v12c-54 8-106 0-160-8s-70-14-116-8-78 12-124 2z" {...L2} />
        <path d="M0 92c46-10 80 6 124 2s70-16 116-10 106 16 160 8v12c-54 8-106 0-160-8s-70-14-116-8-78 12-124 2z" {...L2} />
        <path d="M0 106c46-10 80 6 124 2s70-16 116-10 106 16 160 8v14H0z" {...L3} />
      </g>
      <g {...LINE} strokeWidth="1.6" opacity="0.5">
        <path d="M0 78c46-10 80 6 124 2s70-16 116-10 106 16 160 8" />
        <path d="M0 92c46-10 80 6 124 2s70-16 116-10 106 16 160 8" />
        <path d="M0 106c46-10 80 6 124 2s70-16 116-10 106 16 160 8" />
      </g>
    </g>
  ),
